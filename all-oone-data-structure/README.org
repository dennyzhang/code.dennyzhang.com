...
:PROPERTIES:
:type:     designquestion, inspiring, manydetails
:END:
---------------------------------------------------------------------
All O`one Data Structure
---------------------------------------------------------------------
Similar Problems:
- [[https://brain.dennyzhang.com/insert-delete-getrandom-o1][Insert Delete GetRandom O(1)]]
- [[https://brain.dennyzhang.com/third-maximum-number][Leetcode: Third Maximum Number]]
...
Github: [[url-external:https://github.com/DennyZhang/challenges-leetcode-interesting/tree/master/all-oone-data-structure][challenges-leetcode-interesting]]

Credits To: [[url-external:https://leetcode.com/problems/all-oone-data-structure/description/][leetcode.com]]
