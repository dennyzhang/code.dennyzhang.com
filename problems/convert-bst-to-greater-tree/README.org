...
:PROPERTIES:
:type:     binarytree, convertds, treetraversal
:END:
---------------------------------------------------------------------
...
#+END_HTML
Similar Problems:
- [[https://code.dennyzhang.com/binary-search-tree-to-greater-sum-tree][Binary Search Tree to Greater Sum Tree]]
- [[https://cheatsheet.dennyzhang.com/cheatsheet-leetcode-A4][CheatSheet: Leetcode For Code Interview]]
- [[https://cheatsheet.dennyzhang.com/cheatsheet-followup-A4][CheatSheet: Common Code Problems & Follow-ups]]
- Tag: [[https://code.dennyzhang.com/review-binarytree][#binarytree]], [[https://code.dennyzhang.com/tag/convertds][#convertds]], [[https://code.dennyzhang.com/review-treetraversal][#treetraversal]]
---------------------------------------------------------------------
...
#+BEGIN_SRC python
## https://code.dennyzhang.com/convert-bst-to-greater-tree
