...
[[Leetcode: Construct Quad Tree][https://raw.githubusercontent.com/dennyzhang/challenges-leetcode-interesting/master/images/grid.png]]

It can be divided according to the definition above:

[[Leetcode: Construct Quad Tree][https://raw.githubusercontent.com/dennyzhang/challenges-leetcode-interesting/master/images/grid_divided.png]]

The corresponding quad tree should be as following, where each node is represented as a (isLeaf, val) pair.

For the non-leaf nodes, val can be arbitrary, so it is represented as *.
[[Leetcode: Construct Quad Tree][https://raw.githubusercontent.com/dennyzhang/challenges-leetcode-interesting/master/images/quad_tree.png]]
