* LintCode: Convert Linked List to Array List                    :BLOG:Basic:
...
Github: [[https://github.com/DennyZhang/challenges-leetcode-interesting/tree/master/convert-linked-list-to-array-list][challenges-leetcode-interesting]]
