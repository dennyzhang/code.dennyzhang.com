...
- Tag: [[https://code.dennyzhang.com/tag/classic][#classic]], [[https://code.dennyzhang.com/tag/backtracking][#backtracking]], [[https://code.dennyzhang.com/tag/combination][#combination]]
---------------------------------------------------------------------
...
func backtrack(combination string, next_digits string , m map[byte]string, res *[]string) {
    if len(next_digits) == 0 {
        *res = append(*res, combination)
        return
    }
    for _, ch := range m[next_digits[0]] {
        backtrack(combination+string(ch), next_digits[1:len(next_digits)], m, res)
    }
}
