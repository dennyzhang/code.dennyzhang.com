...
:PROPERTIES:
:type:     random, inspiring, possibilities
:END:
---------------------------------------------------------------------
...
- Tag: [[https://code.dennyzhang.com/review-random][#random]], [[https://code.dennyzhang.com/review-inspiring][#inspiring]], [[https://code.dennyzhang.com/followup-possibilities][#possibilities]]
---------------------------------------------------------------------
...
---------------------------------------------------------------------
- Solution: Drop elements out of range. And map to value in the group by mod

#+BEGIN_SRC python
## https://code.dennyzhang.com/implement-rand10-using-rand7
## Basic Ideas:
##  f(7) -> f(49) -> f(40) -> f(10)
##    0 - 48: 6*x+y
##    0 - 39
...
- Solution: Drop elements out of range. And map to which group by divide
