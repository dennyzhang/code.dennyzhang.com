...
| Some BFS may not necessarily need visited hashmap: say topological BFS sort | [[https://code.dennyzhang.com/course-schedule-ii][LeetCode: Course Schedule II]]           |
| BFS traverse nodes with same value of different positions                   | [[https://code.dennyzhang.com/jump-game-iv][LeetCode: Jump Game IV]]                 |
