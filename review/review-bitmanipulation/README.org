* Review: Bit manipulation problems                             :BLOG:Review:
...
| Name                                      | Summary                                                |
|-------------------------------------------+--------------------------------------------------------|
| Confirm no two adjacent 1s in one integer | X & (X<<1) == 0 [[https://code.dennyzhang.com/maximum-students-taking-exam][LeetCode: Maximum Students Taking Exam]] |
