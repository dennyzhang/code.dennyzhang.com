...
---------------------------------------------------------------------
- [[https://code.dennyzhang.com/tag/bfs][#bfs]]: [[https://code.dennyzhang.com/open-the-lock][Open the Lock]]
#+BEGIN_SRC python
## Blog link: http://code.dennyzhang.com/open-the-lock
...
#+END_SRC
---------------------------------------------------------------------
- [[https://code.dennyzhang.com/tag/dfs][#dfs]]: [[https://code.dennyzhang.com/number-of-islands][Number of Islands]]
#+BEGIN_SRC python
...
#+END_SRC
---------------------------------------------------------------------
- [[https://code.dennyzhang.com/tag/trie][#trie]]: [[https://code.dennyzhang.com/longest-word-in-dictionary][Longest Word in Dictionary]]
#+BEGIN_SRC python
## Blog link: http://code.dennyzhang.com/longest-word-in-dictionary
...
#+END_SRC
---------------------------------------------------------------------
- [[https://code.dennyzhang.com/tag/linkedlist][#linkedlist]]: [[https://code.dennyzhang.com/merge-two-sorted-list][Merge Two Sorted Lists]],
...
---------------------------------------------------------------------
- [[https://code.dennyzhang.com/tag/stack][#stack]]: [[https://code.dennyzhang.com/basic-calculator-iii][Basic Calculator III]], [[https://code.dennyzhang.com/decode-string][Decode String]]
---------------------------------------------------------------------
- [[https://code.dennyzhang.com/tag/backtracking][#backtracking]]: [[https://code.dennyzhang.com/word-search][Word Search]], [[https://code.dennyzhang.com/sudoku-solver][Sudoku Solver]]
---------------------------------------------------------------------
- [[https://code.dennyzhang.com/tag/recursive][#recursive]]: [[https://code.dennyzhang.com/sort-list][Sort List]]
---------------------------------------------------------------------
- [[https://code.dennyzhang.com/tag/combination][#combination]]: [[https://code.dennyzhang.com/letter-combinations-of-a-phone-number][Letter Combinations of a Phone Number]]
---------------------------------------------------------------------
- [[https://code.dennyzhang.com/tag/slidingwindow][#slidingwindow]]: [[https://code.dennyzhang.com/contains-duplicate-ii][Contains Duplicate II]]
---------------------------------------------------------------------
...
---------------------------------------------------------------------
- [[https://code.dennyzhang.com/tag/dynamicprogramming][#dynamicprogramming]]: [[https://code.dennyzhang.com/unique-binary-search-trees][Unique Binary Search Trees]]
---------------------------------------------------------------------
...
#+BEGIN_SRC python
## Blog link: http://code.dennyzhang.com/number-of-1-bits
res = 0
while n != 0:
    n = n & (n-1)
    res += 1
...
#+END_SRC
---------------------------------------------------------------------
- [[https://code.dennyzhang.com/tag/heap][#heap]]: [[https://code.dennyzhang.com/kth-largest-element-in-an-array][Kth Largest Element in an Array]]
#+BEGIN_SRC python
## Blog link: http://code.dennyzhang.com/kth-largest-element-in-an-array
q = []
